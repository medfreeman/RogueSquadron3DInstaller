  LangString HEAD_SectionNGlide				${LANG_English} "nGlide 1.03"
  LangString DESC_SectionNGlide				${LANG_English} "Installs nGlide 1.03 (3DFx emulation). Makes the game playable with cards other than ATi, up to 7860x4320 resolution"
  LangString NGLIDE_DOWNLOAD				${LANG_English} "Downloading nGlide 1.03"

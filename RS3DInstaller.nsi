...
;General
  ...
  !define NGLIDE_VERSION "210"
  ;The nGlide installer download url
  !define NGLIDE_INSTALLER_URL "https://www.zeus-software.com/files/nglide/nGlide${NGLIDE_VERSION}_setup.exe"
...
Section $(HEAD_SectionUpdate) SectionUpdate
  ...
  ;NScurl::http GET "http://media1.gamefront.com/moddb/2009/03/10/rogueupd12.exe" "$2" /INSIST /PAGE /CANCEL /END
...
Section $(HEAD_SectionNGlide) SectionNGlide
  ...
  NScurl::http GET ${NGLIDE_INSTALLER_URL} "$2" /INSIST /PAGE /CANCEL /END
  Pop $0 ;Get the return value
  ${If} $0 != "OK"
    DetailPrint $(DOWNLOAD_ERROR)
    Abort
...
;Descriptions
  ...
  !include ".\resources\translations_nglide.nsi"
